...
jQuery(document).ready(function () {
  ...
  know_tm_intro_tab();
  if (
    jQuery(".know_tm_hero .main_menu, .know_tm_fixed_content .menubar").length
  ) {
...
function know_tm_news_popup() {
  ...
  var modalBox = jQuery(".know_tm_modalbox");
  var button = jQuery(
    ".know_tm_news .know_tm_full_link,.know_tm_news .news_list ul li .details .title a"
  );
  var closePopup = modalBox.find(".close");
...
function know_tm_popup() {
  ...
  jQuery(".popup-design, .popup-vimeo").each(function () {
    // the containers for all your galleries
    jQuery(this).magnificPopup({
      disableOn: 700,
      type: "iframe",
  ...
  jQuery(".webprojete_link").magnificPopup({
    type: "image",
    gallery: {
      enabled: true,
    },
...
function know_tm_owl_carousel() {
  ...
  var carousel2 = jQuery(
    ".know_tm_fixed_content .know_tm_testimonials .owl-carousel"
  );
...
function know_tm_extra_menu() {
  ...
  item.each(function () {
    var element = jQuery(this);
    var content = jQuery(
      element.find(".know_tm_full_link").attr("href")
    ).html();
    element
